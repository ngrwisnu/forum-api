...
describe("ThreadDetails", () => {
  it("should return the correct object", async () => {
    ...
    expect(result.comments[0]).toHaveProperty("likeCount", 0);
  ...
  it("should be able to show the total number of comment's like", async () => {
    const mockTime = new Date();
    jest.spyOn(global, "Date").mockImplementation(() => mockTime);
    ...
    const result = new ThreadDetails(thread, comments, replies, commentsLikes);
